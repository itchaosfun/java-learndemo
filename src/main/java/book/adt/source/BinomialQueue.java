package book.adt.source;// BinomialQueue class
//
...
// vod merge( rhs )       --> Absord rhs into this book.adt.learn.heap
// ******************ERRORS********************************
...
public final class BinomialQueue<AnyType extends Comparable<? super AnyType>>
{
    ...
    /**
     * Find index of book.adt.learn.tree containing the smallest item in the priority queue.
     * The priority queue must not be empty.
     * @return the index of book.adt.learn.tree containing the smallest item.
     */
    ...
    private BinNode<AnyType> [ ] theTrees;  // An array of book.adt.learn.tree roots
