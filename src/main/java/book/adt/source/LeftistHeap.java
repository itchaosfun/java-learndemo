package book.adt.source;// LeftistHeap class
//
...
// void merge( rhs )      --> Absorb rhs into this book.adt.learn.heap
// ******************ERRORS********************************
// Throws UnderflowException as appropriate

/**
 * Implements a leftist book.adt.learn.heap.
...
{
    /**
     * Construct the leftist book.adt.learn.heap.
     */
    public LeftistHeap( )
    {
        root = null;
     ...
     * @param rhs the other leftist book.adt.learn.heap.
     */
