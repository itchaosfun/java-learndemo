package book.adt.source;// Treap class
//
...
public class Treap<AnyType extends Comparable<? super AnyType>>
{
    ...
    /**
     * Insert into the book.adt.learn.tree. Does nothing if x is already present.
    ...
    /**
     * Remove from the book.adt.learn.tree. Does nothing if x is not found.
