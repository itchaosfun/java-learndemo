...
//        String sign = new ApiSignTest().generateSign(1577942363090L);
////        System.out.println("sign = " + sign);

//        SMSTest smsTest = new SMSTest();
//        Long post = smsTest.createPost();
//        System.out.println("post = " + post);

//        System.out.println(new GuidTest().restore(489624499424088064L));

//        new RecombineTest().testRecombine();
