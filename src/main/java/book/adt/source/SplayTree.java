package book.adt.source;// SplayTree class
//
...
/**
 * Implements a top-down splay book.adt.learn.tree.
...
public class SplayTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    /**
     * Insert into the book.adt.learn.tree.
    ...
    /**
     * Remove from the book.adt.learn.tree.
     ...
     *     smaller than any item in the book.adt.learn.tree, then call findMin.
     ...
     *     amortized behavior.
     * A good alternative is to first call find with parameter
     *     larger than any item in the book.adt.learn.tree, then call findMax.
