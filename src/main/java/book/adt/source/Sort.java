...
{
    /**
     * Simple insertion book.adt.learn.sort.
     ...
     * @param i the index of an item in the book.adt.learn.heap.
     ...
     * @int n the logical size of the binary book.adt.learn.heap.
     */
    ...
    void quicksort( AnyType [ ] a, int left, int right )
    {
        ...
        else  // Do an insertion book.adt.learn.sort on the subarray
            insertionSort( a, left, right );
    }

    /**
     * Internal insertion book.adt.learn.sort routine for subarrays
