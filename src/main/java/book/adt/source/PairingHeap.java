...
/**
 * Implements a pairing book.adt.learn.heap.
...
{    
    ...
    /**
     * Construct the pairing book.adt.learn.heap.
     */
    public PairingHeap( )
    {
        root = null;
     ...
     * @throws UnderflowException if pairing book.adt.learn.heap is empty.
     */
    ...
    /**
     * Change the value of the item stored in the pairing book.adt.learn.heap.
     ...
     * Links first and second together to satisfy book.adt.learn.heap order.
     * @param first root of book.adt.learn.tree 1, which may not be null.
     *    first.nextSibling MUST be null on entry.
     * @param second root of book.adt.learn.tree 2, which may be null.
     * @return result of the book.adt.learn.tree merge.
     */
    ...
    private PairNode<AnyType> [ ] doubleIfFull( PairNode<AnyType> [ ] array, int index )
    {
        ...
        // The book.adt.learn.tree array for combineSiblings
    ...
    private PairNode<AnyType> combineSiblings( PairNode<AnyType> firstSibling )
    {
        ...
        if( j == numSiblings - 3 )
            ...
            // Now go right to left, merging last book.adt.learn.tree with
